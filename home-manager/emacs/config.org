...
(use-package lsp-mode
  ...
  :hook
  ((elixir-ts-mode . lsp)
   (elixir-ts-mode . yas-minor-mode)) ;; Automatically start yasnippet in elixir-mode
  :init
...
(use-package yasnippet
  ...
  :config
  (yas-reload-all)
  (define-key yas-minor-mode-map (kbd "C-k") 'yas-next-field)
  (define-key yas-minor-mode-map (kbd "C-j") 'yas-prev-field))

#+end_src 

* TODO Vterm like async
#+begin_src emacs-lisp
#+end_src 
